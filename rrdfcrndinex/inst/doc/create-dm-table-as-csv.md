...
dataCubeFile<- system.file("extdata/sample-rdf", "DC-DM-sample.ttl", package="rrdfcrndinex")
...
```r
dmtableFile<- file.path( system.file("extdata/sample-cfg", package="rrdfcrndinex"), "dm.AR.csv" )
