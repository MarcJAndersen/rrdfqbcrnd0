...
```
## SQLite database stored as  /tmp/RtmpY52yYs/file6c6f7418a8a3
```
...
```
## SQLite database dump in  /tmp/RtmpY52yYs/file6c6f304518a4
```
...
```
## SQLite database dump modified stored as  /tmp/RtmpY52yYs/file6c6ff6cea90
```
...
```r
dataFilemap<- system.file("extdata/sample-rdf", "adsl-map.ttl", package="rrdfcrndinex")
dataFilemap
```
...
```r
dataFile<- system.file("extdata/sample-rdf", "adsl.ttl", package="rrdfcrndinex")
dataFile
```
