...
## rrdf store saved to turle file: /tmp/RtmpNhOhu5/cdisc-rdf.ttl
...
```
## File /home/ma/R/x86_64-redhat-linux-gnu-library/3.2/rrdfqbcrnd0/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-01-03 13:52:55 size 2310300 bytes
```
...
SPARQL script stored in   /tmp/RtmpNhOhu5/get-rdf.disc.org.rq 
