...
## rrdf store saved to turle file: /tmp/RtmpmZaoPq/cdisc-rdf.ttl
...
```
## File /home/ma/R/x86_64-redhat-linux-gnu-library/3.2/rrdfqbcrnd0/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2015-12-20 00:41:38 size 2315967 bytes
```
...
SPARQL script stored in   /tmp/RtmpmZaoPq/get-rdf.disc.org.rq 
