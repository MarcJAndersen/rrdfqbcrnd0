...
```
    ...
    ## rrdf store saved to turle file: /tmp/Rtmphr3eHW/cdisc-rdf.ttl
...
```
    ...
    ## File /home/ma/projects/rrdfqbcrnd0/rrdfcdisc/inst/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-06-29 20:11:29 size 2310300 bytes
...
SPARQL script stored in /tmp/Rtmphr3eHW/get-rdf-disc-org.rq
