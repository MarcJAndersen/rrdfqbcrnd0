...
## rrdf store saved to turle file: /tmp/RtmpHT95TK/cdisc-rdf.ttl
...
```
## File /home/ma/projects/R-projects/rrdfqbcrnd0/rrdfcdisc/inst/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-01-06 20:32:27 size 2310300 bytes
```
...
SPARQL script stored in   /tmp/RtmpHT95TK/get-rdf.disc.org.rq 
