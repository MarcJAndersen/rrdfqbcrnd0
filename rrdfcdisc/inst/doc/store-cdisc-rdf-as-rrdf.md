...
## rrdf store saved to turle file: /tmp/RtmpV0r5zu/cdisc-rdf.ttl
...
```
## File /home/ma/projects/rrdfqbcrnd0/rrdfcdisc/inst/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-01-05 18:39:51 size 2310300 bytes
```
...
SPARQL script stored in   /tmp/RtmpV0r5zu/get-rdf.disc.org.rq 
