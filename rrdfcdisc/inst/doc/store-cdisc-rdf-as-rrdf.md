...
## rrdf store saved to turle file: /tmp/Rtmp5TnJM2/cdisc-rdf.ttl
...
```
## File /home/ma/R/x86_64-redhat-linux-gnu-library/3.2/rrdfqbcrnd0/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-01-04 23:35:25 size 2310300 bytes
```
...
SPARQL script stored in   /tmp/Rtmp5TnJM2/get-rdf.disc.org.rq 
