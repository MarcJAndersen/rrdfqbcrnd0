...
## rrdf store saved to turle file: /tmp/RtmpkpDaBE/cdisc-rdf.ttl
...
```
## File /home/ma/projects/R-projects/rrdfqbcrnd0/rrdfcdisc/inst/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-01-05 21:37:50 size 2310300 bytes
```
...
SPARQL script stored in   /tmp/RtmpkpDaBE/get-rdf.disc.org.rq 
