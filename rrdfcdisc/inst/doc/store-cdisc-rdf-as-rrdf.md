...
```
    ...
    ## rrdf store saved to turle file: /tmp/RtmplYWsBk/cdisc-rdf.ttl
...
```
    ...
    ## File /home/ma/projects/rrdfqbcrnd0/rrdfcdisc/inst/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-03-01 21:45:49 size 2310304 bytes
...
SPARQL script stored in /tmp/RtmplYWsBk/get-rdf.disc.org.rq
