...
```
    ...
    ## rrdf store saved to turle file: /tmp/RtmpWxmir4/cdisc-rdf.ttl
...
```
    ...
    ## File /home/ma/projects/rrdfqbcrnd0/rrdfcdisc/inst/extdata/CDISC-standards-rdf/cdisc-rdf.zip created 2016-03-07 23:01:15 size 2310300 bytes
...
SPARQL script stored in /tmp/RtmpWxmir4/get-rdf.disc.org.rq
...
This worked as expected as of 07-feb-2016.
