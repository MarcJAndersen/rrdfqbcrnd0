...
system(paste("/opt/d2rq-0.8.1/dump-rdf -b http://www.example.org/datasets/ -o /tmp/adsl.ttl -l /tmp/xx.sql /tmp/adsl-map.ttl"))
...
rq<-"
select * where {
<http://www.example.org/datasets/ADSL/01-718-1254> ?p ?o .
}
"
