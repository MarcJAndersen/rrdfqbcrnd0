...
```
## Loading cube specfication from  /home/ma/R/x86_64-redhat-linux-gnu-library/3.1/rrdfqbcrnd0/extdata/CUBE-standards-rdf/cube.ttl
```
...
```
## Loading cube from  /home/ma/R/x86_64-redhat-linux-gnu-library/3.1/rrdfqbcrnd0/extdata/sample-rdf/DC-DEMO-sample.ttl
```
