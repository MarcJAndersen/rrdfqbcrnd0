...
```
## DM cube stored as  /tmp/Rtmpy8nTUb/DC-DM-R-V-0-5-2.ttl
```
...
```
## AE cube stored as  /tmp/Rtmpy8nTUb/DC-AE-R-V-0-5-2.ttl
```
...
```
## DEMO cube stored as  /tmp/Rtmpy8nTUb/DC-DEMO-R-V-0-5-2.ttl
```
