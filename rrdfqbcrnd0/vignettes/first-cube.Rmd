...
The next statement shows the first 30 triples in the cube, 
where the subject is a qb:Observation.
```{r}
...
Here we remove one of the dimensions from the cube in observation ds:obs1. Note: for the remove.triple function the components must be given as the full qualified URI.
```{r, eval=FALSE}
remove.triple(cubeData,
  subject="http://www.example.org/dc/example/ds/obs1",
  predicate="http://www.example.org/dc/example/prop/category",
