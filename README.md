...
```r
library(devtools)
install_local("rrdfancillary")
install_local("rrdfcdisc")    
install_local("rrdfqb")       
install_local("rrdfqbcrnd0")  
install_local("rrdfqbcrndcheck")
install_local("rrdfqbpresent")
install_local("rrdfqbcrndex")
```
