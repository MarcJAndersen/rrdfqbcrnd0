...
```
    ...
    ## DM cube stored as  /tmp/RtmpPGWqxK/DC-DM-R-V-0-5-2.ttl
...
```
    ...
    ## AE cube stored as  /tmp/RtmpPGWqxK/DC-AE-R-V-0-5-2.ttl
...
```
    ...
    ## DEMO cube stored as  /tmp/RtmpPGWqxK/DC-DEMO-R-V-0-5-2.ttl
