...
```
    ...
    ## DM cube stored as  /tmp/RtmpdFEuto/DC-DM-R-V-0-5-2.ttl
...
```
    ...
    ## AE cube stored as  /tmp/RtmpdFEuto/DC-AE-R-V-0-5-2.ttl
...
```
    ...
    ## DEMO cube stored as  /tmp/RtmpdFEuto/DC-DEMO-R-V-0-5-2.ttl
