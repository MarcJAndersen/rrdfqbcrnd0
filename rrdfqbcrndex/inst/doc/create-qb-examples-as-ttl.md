...
```
    ...
    ## DM cube stored as  /tmp/Rtmp2lWPO6/DC-DM-R-V-0-5-2.ttl
...
```
    ...
    ## AE cube stored as  /tmp/Rtmp2lWPO6/DC-AE-R-V-0-5-2.ttl
...
```
    ...
    ## DEMO cube stored as  /tmp/Rtmp2lWPO6/DC-DEMO-R-V-0-5-2.ttl
