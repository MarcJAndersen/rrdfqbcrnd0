...
```
    ...
    ## SQLite database stored as  /tmp/RtmpgwUgO5/file46de26e6f68a
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpgwUgO5/file46de35b83f5c
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpgwUgO5/file46de261b7350
...
```
    ...
    ## File  /tmp/RtmpgwUgO5/adsl-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpgwUgO5/adsl.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
