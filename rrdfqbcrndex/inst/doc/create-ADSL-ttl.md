...
```
    ...
    ## SQLite database stored as  /tmp/RtmpcsNlsC/file29a4561fd201
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpcsNlsC/file29a46cbb6270
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpcsNlsC/file29a41996f421
...
```
    ...
    ## File  /tmp/RtmpcsNlsC/adsl-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpcsNlsC/adsl.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
