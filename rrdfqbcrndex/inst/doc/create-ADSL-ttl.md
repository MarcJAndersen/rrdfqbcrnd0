...
```
## SQLite database stored as  /tmp/RtmpfwI6ac/file2f8665048f0f
```
...
```
## SQLite database dump in  /tmp/RtmpfwI6ac/file2f8635426d2b
```
...
```
## SQLite database dump modified stored as  /tmp/RtmpfwI6ac/file2f86139bd35b
```
...
```
## File  /tmp/RtmpfwI6ac/adsl-map.ttl  copied to directory  /home/ma/projects/R-projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
```
...
```
## File  /tmp/RtmpfwI6ac/adsl.ttl  copied to directory  /home/ma/projects/R-projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
```
