...
```
    ...
    ## SQLite database stored as  /tmp/RtmpMGeZtv/file494f220e654e
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpMGeZtv/file494f59402f5f
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpMGeZtv/file494f1ed6f1eb
...
```
    ...
    ## File  /tmp/RtmpMGeZtv/adsl-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpMGeZtv/adsl.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
