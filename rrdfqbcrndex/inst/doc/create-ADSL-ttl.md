...
```
    ...
    ## SQLite database stored as  /tmp/Rtmp9kEWVz/file208e413e6c8d
...
```
    ...
    ## SQLite database dump in  /tmp/Rtmp9kEWVz/file208e78b9e472
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/Rtmp9kEWVz/file208e4b5bb564
...
```
    ...
    ## File  /tmp/Rtmp9kEWVz/adsl-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/Rtmp9kEWVz/adsl.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
