...
```
    ...
    ## SQLite database stored as  /tmp/RtmpJ5BU3w/file215664a66048
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpJ5BU3w/file215614c61ea5
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpJ5BU3w/file2156b754be2
...
```
    ...
    ## File  /tmp/RtmpJ5BU3w/adae-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpJ5BU3w/adae.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
