...
```
## SQLite database stored as  /tmp/RtmpcBenvo/file2ff64815d811
```
...
```
## SQLite database dump in  /tmp/RtmpcBenvo/file2ff65d8691c1
```
...
```
## SQLite database dump modified stored as  /tmp/RtmpcBenvo/file2ff64a8c129e
```
...
```
## File  /tmp/RtmpcBenvo/adae-map.ttl  copied to directory  /home/ma/projects/R-projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
```
...
```
## File  /tmp/RtmpcBenvo/adae.ttl  copied to directory  /home/ma/projects/R-projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
```
