...
```
    ...
    ## SQLite database stored as  /tmp/RtmpwxwGDM/file19231899a8ab
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpwxwGDM/file1923478413c4
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpwxwGDM/file19236f65be16
...
```
    ...
    ## File  /tmp/RtmpwxwGDM/adae-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpwxwGDM/adae.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
