...
```
    ...
    ## SQLite database stored as  /tmp/RtmpENzFJ8/file14fea8a8b0c
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpENzFJ8/file14fe351fa82
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpENzFJ8/file14fe17368597
...
```
    ...
    ## File  /tmp/RtmpENzFJ8/adae-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpENzFJ8/adae.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
