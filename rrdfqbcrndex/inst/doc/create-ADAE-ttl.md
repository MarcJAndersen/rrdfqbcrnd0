...
```
    ...
    ## SQLite database stored as  /tmp/RtmpW6xhS7/file1c242d55210f
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpW6xhS7/file1c241947c5fd
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpW6xhS7/file1c2446775774
...
```
    ...
    ## File  /tmp/RtmpW6xhS7/adae-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpW6xhS7/adae.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
