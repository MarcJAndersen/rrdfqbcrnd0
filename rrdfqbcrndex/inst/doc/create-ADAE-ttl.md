...
```
    ...
    ## SQLite database stored as  /tmp/Rtmp31lC9m/file26d340824f
...
```
    ...
    ## SQLite database dump in  /tmp/Rtmp31lC9m/file26d317aa302d
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/Rtmp31lC9m/file26d33c589697
...
```
    ...
    ## File  /tmp/Rtmp31lC9m/adae-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/Rtmp31lC9m/adae.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
