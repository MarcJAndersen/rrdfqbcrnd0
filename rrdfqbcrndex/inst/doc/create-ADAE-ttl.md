...
```
    ...
    ## SQLite database stored as  /tmp/RtmpfCo7Av/file40c54a38cc22
...
```
    ...
    ## SQLite database dump in  /tmp/RtmpfCo7Av/file40c53fc9532a
...
```
    ...
    ## SQLite database dump modified stored as  /tmp/RtmpfCo7Av/file40c57e2e1b40
...
```
    ...
    ## File  /tmp/RtmpfCo7Av/adae-map.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
...
```
    ...
    ## File  /tmp/RtmpfCo7Av/adae.ttl  copied to directory  /home/ma/projects/rrdfqbcrnd0/rrdfqbcrndex/inst/extdata/sample-rdf
