...
The result of the function call Get.filenames.for.cdisc.standards() is itended to match the output from find.
...
cdisc.save.zip<- Create.cdisc.standards.from.local(cdisc.files.dir= "~/projects/phrmwg/rdf.cdisc.org")
