...
#TW: To pass in as a parameter. Will have values: demog, ae, etc.
#   Must match the name in the workbook sheet (demog-components), etc.
...
cubeVersion <- "0-5-3c"  # 0-5-3 using .XLSX for DM Skeleton  
...
# Workbook as source of skeleton components and cube metadata
...
#TODO: Cube description, able and title from Workbook
