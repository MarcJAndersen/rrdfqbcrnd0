...
#------------  Declarations    ------------------------------------------------
#DEL endpoint<- "http://localhost:3030/cdisc/query"

# NOTE: For pav:Version (dot, notdash) and output file name
cubeVersion <- "0-5-3h"  # 0-5-3 using .XLSX for DM Skeleton  

#TODO TW  : Change to use system.file so it picks it up from the package.
     # system.file("extdata/sample-cfg", "RDFCubeWorkBook.xlsx", package="rrdfqbcrnd0")
sdtm.terminology.file= load.rdf("C:/_gitHub/rrdfqbcrnd0/inst/extdata/sample-cfg/sdtm-terminology-2013-06-28.ttl", format="N3")
...
#       Or name files using domainName?  <domainName>.AR.CSV.......
...
qb.buildDSD(storeDM, DMprefixlist, DMobsData, DMSkeletonSource,
            ...
            codelist.source=sdtm.terminology.file
          )
