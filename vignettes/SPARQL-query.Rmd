...
vignette: >
  %\VignetteIndexEntry{SPARQL query}
...
Here it comes - the code should be enabled - but it hangs.
Use eval=TRUE to get it run. Note that it looks like that it should run in a browser.
