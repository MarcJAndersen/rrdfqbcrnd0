...
uqr<-unique(observationsRowDim[,c(-1)])
uqr[,"rowno"]<- 1:nrow(uqr)
observationsRowDimE<-merge(observationsRowDim,uqr)
observationsRowDimE[,c("s","rowno")]
