...
```
## SQLite database stored as  /tmp/Rtmp6oxcqV/file20097e8b2347
```
...
```
## SQLite database dump in  /tmp/Rtmp6oxcqV/file20094370743a
```
...
```
## SQLite database dump modified stored as  /tmp/Rtmp6oxcqV/file20091cee4199
```
...
```r
dataFilemap<- system.file("extdata/sample-rdf", "adae-map.ttl", package="rrdfcrndex")
dataFilemap
```
...
```r
dataFile<- system.file("extdata/sample-rdf", "adae.ttl", package="rrdfcrndex")
dataFile
```
